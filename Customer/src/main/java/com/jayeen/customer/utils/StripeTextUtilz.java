...
/**
 * Utility class for common text-related operations on Stripe da0ta coming from the server.
 */
public class StripeTextUtilz {
    ...
    static String shaHashInput(@Nullable String toHash) {
        if (com.stripe.android.StripeTextUtils.isBlank(toHash)) {
            return null;
        }
