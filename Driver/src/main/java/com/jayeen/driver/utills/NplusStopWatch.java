...
public class NplusStopWatch extends View{
    ...
    public interface  OnPrettySeekBarChangeListener{
        void onProgressChanged(NplusStopWatch nplusStopWatch, int progress, boolean touched);

        void onStartTrackingTouch(NplusStopWatch seekBar);

        void onStopTrackingTouch(NplusStopWatch seekBar);
    }
    ...
    public NplusStopWatch(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        array = context.getTheme().obtainStyledAttributes(attrs, R.styleable.NplusStopWatch, 0, 0);
        ...
        try{
            outerCircleFillColor = array.getInteger(R.styleable.NplusStopWatch_outerCircleFillColor, R.color.black);
            innerCircleFillColor = array.getInteger(R.styleable.NplusStopWatch_innerCircleFillColor, R.color.white);
            maxProgress = array.getInteger(R.styleable.NplusStopWatch_maxProgress, 100);
    ...
    private void onProgressChanged(NplusStopWatch nplusStopWatch, int progress, boolean touched){
        if(onPrettySeekBarChangeListener != null){
