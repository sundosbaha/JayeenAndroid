...
public class CircularMusicProgressBar extends android.support.v7.widget.AppCompatImageView {
    ...
    public CircularMusicProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.jayeen.driver.R.styleable.CircularMusicProgressBar, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(com.jayeen.driver.R.styleable.CircularMusicProgressBar_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(com.jayeen.driver.R.styleable.CircularMusicProgressBar_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(com.jayeen.driver.R.styleable.CircularMusicProgressBar_border_overlay, DEFAULT_BORDER_OVERLAY);
        mDrawAntiClockwise = a.getBoolean(com.jayeen.driver.R.styleable.CircularMusicProgressBar_draw_anticlockwise, DEFAULT_DRAW_ANTI_CLOCKWISE);
        mFillColor = a.getColor(com.jayeen.driver.R.styleable.CircularMusicProgressBar_fill_color, DEFAULT_FILL_COLOR);
        mInnrCircleDiammeter = a.getFloat(com.jayeen.driver.R.styleable.CircularMusicProgressBar_centercircle_diammterer, DEFAULT_INNTER_DAIMMETER_FRACTION);
        mProgressColor = a.getColor(com.jayeen.driver.R.styleable.CircularMusicProgressBar_progress_color, DEFAULT_PROGRESS_COLOR);
        mProgressColor = a.getColor(com.jayeen.driver.R.styleable.CircularMusicProgressBar_progress_color, DEFAULT_PROGRESS_COLOR);
        mBaseStartAngle = a.getFloat(com.jayeen.driver.R.styleable.CircularMusicProgressBar_progress_startAngle, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float sweetAngle = mProgressValue / angleValue * 360;
